import IPy,subprocess,json,ContainerNotFound
...
class VZ:
    ...
    def enable_tun(self):
        ...
        if ret == 0:
            #enable tun
            ret = subprocess.call("/usr/sbin/vzctl set {} --devnodes net/tun:rw --capability net_admin:on --save".format(self.ctid),shell=True)
        else:
            return False
